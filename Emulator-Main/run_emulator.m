...
for block_ind = 1:nblocks
    ...
    [TEMP_image_done,TEMP_true_SIC] = deal(zeros(block_length,1));
    [TEMP_length_measured,TEMP_length_ice_measured, TEMP_sample_orients] = deal(zeros(block_length,n_crossings)); 
    ...
    parfor block_subind = 1:block_length
        ...
        if TEMP_image_done(block_subind) == 0
    ...
    save([Code_folder '/Emulator_Data'],'length_measured','length_ice_measured','image_done','sample_orients','true_SIC','image_done')
